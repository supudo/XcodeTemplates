...
// define the buffer which is used to set the
// active buffer(using double buffering)
#define backbuffer 0x10	 

// This bit, when set allows OAM
// (Object Attribute memory) to be updated during a horizontal blank
#define H_BLANK_OAM 0x20    

// Sprite data is stored in a 2D array(dont use this!!)
#define OBJ_MAP_2D 0x00

// Sprite data is stored in a 1D array
